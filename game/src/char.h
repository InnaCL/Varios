...
enum EPointTypes
{
	...
	POINT_ATTBONUS_JINNO = 138, 
	POINT_ATTBONUS_SHINSOO = 139, 
	POINT_ATTBONUS_CHUNJO = 140, 
...
//		AttackLog			m_kAttackLog;
	...
	public:
		...
		void				SetPetRider(LPCHARACTER ch);
		LPCHARACTER			GetPetRider() const; // rider on pet
		bool				IsRiding() const;
