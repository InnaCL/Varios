...
void CGuild::RequestDepositMoney(LPCHARACTER ch, long long iGold)
{
...
void CGuild::RecvMoneyChange(long long iGold)
{
	m_data.gold = iGold;
...
void CGuild::RecvWithdrawMoneyGive(long long iChangeGold)
{
